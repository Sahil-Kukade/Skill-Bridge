  ...
  return (
    <div className="px-4 py-6 md:px-6 lg:px-10">
      ...
      {loading ? (
        ...
        <div>
          {/* Chart and Stats */}
          <div className="my-6 flex flex-col lg:flex-row lg:space-x-6 space-y-6 lg:space-y-0">
            {/* Chart */}
            <div className="lg:w-2/3 w-full rounded-md bg-richblack-800 p-4">
            ...
            {/* Stats */}
            <div className="lg:w-1/3 w-full flex flex-col rounded-md bg-richblack-800 p-6">
